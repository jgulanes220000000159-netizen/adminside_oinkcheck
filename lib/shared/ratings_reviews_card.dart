                  ...
                  decoration: BoxDecoration(
                    ...
                    gradient: LinearGradient(
                      ...
                      colors: [
                        ...
                        const Color(0xFF2D7204).withOpacity(0.8),
                      ],
                    ),
                  ),
                  child: Padding(
          ...
          builder: (context, mlEvaluationsSnapshot) {
            ...
            if (appRatingsSnapshot.hasData) {
              for (final doc in appRatingsSnapshot.data!.docs) {
                ...
                if (userRole == 'farmer') {
                  farmerRatingsCount++;
                } else if (userRole == 'expert' || userRole == 'head_veterinarian') {
                  expertRatingsCount++;
                }

                // Calculate average from farmers and experts only (excluding ML experts)
                if (rating != null && rating > 0 && userRole != 'machine_learning_expert') {
                  totalRating += rating;
                  ratingCount++;
                }
              }
            ...
            final totalCount = farmerRatingsCount + expertRatingsCount + mlExpertRatingsCount;
